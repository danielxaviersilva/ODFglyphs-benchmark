...
//  window.setDefaultParameters();
  if(argc == 1) {
      ...
      std::cout << "[2]: Performance benchmark mode: 0,1,2,3 stands for the added functionalities (Indexing, Instancing, Symmetry, Coalescent lookup)" << std::endl;
      ...
      window.setbenchmarkCategory(atoi(argv[2]));
       ...
       std::cout << "[3] (optional): Path for output data file:" << std::endl;
        ...
        std::cout << "Benchmark Enabled. Glyphs will be drawn from 25 to 10000, 100 times." << std::endl;
